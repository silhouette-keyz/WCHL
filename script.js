...
document.addEventListener("DOMContentLoaded", function () {
      ...
      closePurchaseBtn.addEventListener("click", () => purchaseModal.classList.add("hidden"));
      ...
      document.getElementById("biodata-form").addEventListener("submit", function (e) {
        ...
        if (name && email && phone) {
          ...
          document.getElementById("purchase-event-title").textContent = selectedEvent.title;
          document.getElementById("selected-type").textContent = selectedEvent.ticketType;
          document.getElementById("selected-total").textContent = `IDR ${Number(selectedEvent.price).toLocaleString()}`;
      ...
      document.getElementById("confirm-purchase-btn").addEventListener("click", function () {
        ...
        const biodata = JSON.parse(localStorage.getItem("ticketBiodata"));
        alert(`Pembelian Berhasil!\nNama: ${biodata.name}\nEvent: ${biodata.event.title}\nHarga: IDR ${Number(biodata.event.price).toLocaleString()}`);
